...
import Reveal from "../Reveal"; // 1. Importa il componente Reveal
              ...
              <div className="grid grid-cols-1 gap-y-10 gap-x-16 md:grid-cols-[auto_auto_auto]">
                <Reveal delay="100ms">
                  <div className="flex flex-col">
                    <p className="mb-4 opacity-50">Position</p>
                    <p className="mb-2">
                ...
                <Reveal delay="200ms">
                  <div className="flex flex-col gap-4">
                    <p className="mb-2 uppercase opacity-50">Get in touch</p>
                ...
                <Reveal delay="300ms">
                  <div className="flex flex-col">
                    <p className="mb-4 opacity-50">Social</p>
          ...
          <div className="md:hidden pt-5 border-t border-white/15">
            {[
              { label: "Position", content: (
                <div className="pb-6">
                  <p className="mb-2">44 Wickham St · 44 Wickham St, <br /> Prior&apos;s-Land,</p>
                  <p>061-409-439</p>
                </div>
              )},
              ...
              { label: "Social", content: (
                <div className="pb-6 flex flex-col gap-2">
                  ...
                  <SocialLink label="Facebook" url="..." />
                  <SocialLink label="Pinterest" url="..." />
                </div>
              )}
            ].map((item, idx) => (
              <Reveal key={idx} delay={`${idx * 100}ms`}>
                <div className="border-b border-white/15">
                  ...
                  >
                    ...
                    <span className="text-3xl leading-none">{openIndex === idx ? "−" : "+"}</span>
                  </button>
                  <div className={`overflow-hidden transition-[max-height,opacity] duration-500 ${openIndex === idx ? "max-h-60 opacity-100" : "max-h-0 opacity-0"}`}>
                    {item.content}
                  </div>
                </div>
              </Reveal>
