...
export default function Faq() {
  ...
  return (
    <div
      key={i}
      className={`border uppercase transition-colors duration-300 mb-2
    ...
    >
      ...
      >
        {/* CONTAINER SINISTRA: Numero + Domanda */}
        <div className="flex items-center gap-2 md:gap-12">
          
          {/* Numero: centrato verticalmente rispetto alla domanda */}
      ...
      >
        <div className="pb-10 px-[calc(2.5em+2px)] md:px-[calc(6vw+24px)]"> 
          {/* Il padding-left sopra è calcolato per allineare la risposta sotto l'inizio del testo della domanda */}
